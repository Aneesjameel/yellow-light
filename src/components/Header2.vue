...
<template>
    ...
    <Disclosure as="nav"  v-slot="{ open }">
      ...
      <div class="flex items-center space-x-4">
        <!-- B2B Button -->
        <button class="border border-black rounded-full px-3 py-1 text-sm">
          B2B
        </button>
  
        <!-- Search Icon -->
        <button class="text-gray-700 hover:text-yellow-500">
        ...
        <!-- Cart Icon -->
        <button class="relative text-gray-700 hover:text-yellow-500">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6">
        ...
        <!-- User Account Links -->
        <div class="flex space-x-4">
          <a href="#" class="text-gray-700 hover:text-yellow-500">마이페이지</a>
          <a href="#" class="text-gray-700 hover:text-yellow-500">로그아웃</a>
        </div>
