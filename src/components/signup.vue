<template>
  <div class="max-w-lg mx-auto p-6 mt-20">
    ...
    <!-- Social and Business Signup -->
    <div class="mb-6">
      <button
        class="relative rounded-2xl w-full bg-[#03C75A] text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline"
        type="submit">
        <img src="/btnG.png" alt="" class="absolute top-[9px]">
        네이버로 간편 회원가입
      </button>
      <button
        class="mt-2 rounded-2xl w-full border border-black bg-white hover:bg-gray-600 text-black hover:text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline"
        type="submit">
        사업자 회원가입
      </button>
    </div>
